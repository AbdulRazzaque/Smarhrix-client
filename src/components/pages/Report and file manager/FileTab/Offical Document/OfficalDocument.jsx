...
const OfficalDocument = () => {
  ...
  const handleClose = () => {
    ...
    const columns = [
        ...
        { field: 'LeaveType', headerName: 'Employee', width: 150 },
        { field: 'Reason', headerName: 'Company Name', width: 150 },
        { field: 'Status', headerName: 'Promotion Title', width: 150 },
  ...
  return (
    ...
    <div className="col-md-8  ml-3">
      ...
      <div className="d-flex justify-content-start">
        <div className="p-2 boxtitle">All Offical Document</div>
...
export default OfficalDocument