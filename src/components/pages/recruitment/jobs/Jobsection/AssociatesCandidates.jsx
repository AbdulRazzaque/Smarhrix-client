...
const AssociatesCandidates = () => {
    const columns = [
        { field: 'id', headerName: 'S.N', width: 90 },
        { field: 'LeaveType', headerName: 'Candidate Name', width: 150 },
        { field: 'Reason', headerName: 'City', width: 150 },
        { field: 'Status', headerName: 'Candidate Status', width: 150 },
        { field: 'Duration', headerName: 'Phone', width: 150 },
  ...
  return (
    ...
    <div className="col-md-8  ml-3">
      ...
      <div className="d-flex justify-content-start">
        <div className="p-2 boxtitle">Associated Candidates</div>
...
export default AssociatesCandidates
