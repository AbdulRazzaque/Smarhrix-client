...
const Contact = () => {
    const columns = [
        ...
        { field: 'LeaveType', headerName: 'Contact Name', width: 150 },
        { field: 'Reason', headerName: 'Email', width: 150 },
        { field: 'Status', headerName: 'job Title', width: 150 },
        { field: 'Duration', headerName: 'Phone', width: 150 },
        { field: 'Department', headerName: 'Status', width: 150 },
  ...
  return (
    ...
    <div className="col-md-8  ml-3">
      ...
      <div className="d-flex justify-content-start">
        <div className="p-2 boxtitle">Contacts</div>
