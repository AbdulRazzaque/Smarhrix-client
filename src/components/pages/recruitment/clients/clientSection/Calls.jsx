...
const Calls = () => {
    const columns = [
        ...
        { field: 'LeaveType', headerName: 'Topic', width: 150 },
        { field: 'Reason', headerName: 'Call Type', width: 150 },
        { field: 'Status', headerName: 'Call Purpose', width: 150 },
        { field: 'Duration', headerName: 'Start Time', width: 150 },
  ...
  return (
    ...
    <div className="col-md-8  ml-3">
      ...
      <div className="d-flex justify-content-start">
        <div className="p-2 boxtitle">Calls</div>
