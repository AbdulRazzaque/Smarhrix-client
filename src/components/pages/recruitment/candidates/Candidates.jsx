...
function Candidates() {
    ...
    const columns = [
        ...
        { field: 'CompanyName', headerName: 'Candidate Name', width: 150 },
        { field: 'Email', headerName: 'City', width: 150 },
        { field: 'Phone', headerName: 'Phone', width: 150 },
        { field: 'City', headerName: 'Source', width: 150 },
        { field: 'City', headerName: 'Resume', width: 150 },
    ...
    return (
      ...
      <p className='sidTitle'>Dashboard / <span>Candidates</span></p>
      <p className='sidTitle2'>ALL Candidates</p>
    </div>
...
{/* ===================================================================================================================================================================== */}
    ...
    <div className="col-md-8 mt-5 ml-3">
      ...
      <div className="d-flex justify-content-start">
        <div className="p-2 boxTitle">Manage Candidates</div>
    ...
    <div className="col-md-3 mt-5 mr-2">
      ...
      <div className="d-flex justify-content-end">
        ...
        <div className="p-2 ">
            <Button variant="outlined" startIcon={<AddCircleIcon style={{ fontSize: '25px',color:'#2F69FF' }}/>}style={{ fontSize: '14px',borderRadius: 50 ,color:'#2F69FF', backgroundColor:'white', textTransform:'none'}} onClick={()=>history.push("/AddCadidate")} >
        Add Candidate
        </Button>
        </div>
      </div>
