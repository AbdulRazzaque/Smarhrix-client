...
const Award = () => {
    const columns = [
        ...
        { field: 'LeaveType', headerName: 'Award Name', width: 150 },
        { field: 'Reason', headerName: 'Employee', width: 150 },
        { field: 'Status', headerName: 'Company', width: 150 },
        { field: 'Duration', headerName: 'Department', width: 150 },
        { field: 'Duration', headerName: 'Award Date', width: 150 },
  ...
  return (
    ...
    <div className="col-md-8  ml-3">
      ...
      <div className="d-flex justify-content-start">
        <div className="p-2 boxtitle">Award</div>
