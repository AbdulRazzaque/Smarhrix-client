...
const Complaints = () => {
    const columns = [
        ...
        { field: 'Reason', headerName: 'Complaint From', width: 150 },
        { field: 'Status', headerName: 'Complaint Against', width: 150 },
        { field: 'LeaveType', headerName: 'Company', width: 150 },
        { field: 'Duration', headerName: 'Complaint Title', width: 150 },
        { field: 'Duration', headerName: 'Complaint Date', width: 150 },
  ...
  return (
    ...
    <div className="col-md-8  ml-3">
      ...
      <div className="d-flex justify-content-start">
        <div className="p-2 boxtitle">Complaints</div>
