...
const BootstrapDialog = styled(Dialog)(({ theme }) => ({
 ...
 const AddTerminations = ({open,handleClickOpen,handleClose})=> {
...
{/* ===================================================================================================================================================================== */}
        ...
        <p className="whitboxtitle ml-4 my-4">Termination Info</p>
        ...
        <div className="d-flex align-items-center my-3">
            ...
            <Autocomplete
              ...
              <div className="col-6">
              <InputLabel htmlFor="outlined-basic">Termination To*</InputLabel>
              <TextField
                id="outlined-basic"
                sx={{ 
                width:'100%',   maxWidth: '500Px' 
        ...
        <div className="d-flex align-items-center my-3">
            ...
            <div className="col-6">
            <InputLabel htmlFor="outlined-basic">Termination Type *</InputLabel>
              <TextField
                id="outlined-basic"
                sx={{ 
                width:'100%',   maxWidth: '500Px' 
