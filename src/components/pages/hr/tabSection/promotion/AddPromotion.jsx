...
const BootstrapDialog = styled(Dialog)(({ theme }) => ({
 ...
 const AddPromotion= ({open,handleClickOpen,handleClose})=> {
...
{/* ===================================================================================================================================================================== */}
        ...
        <p className="whitboxtitle ml-4 my-4">Add Promotion</p>
              ...
              <Autocomplete
                    ...
                    getOptionLabel={(department)=>department.name}
                     ...
                     sx={{ 
                        width:'100%',   maxWidth: '500Px' 
                        }}
                    renderInput={(params) => <TextField {...params} placeholder='Select Employee' required/>}
                    />
        ...
        <div className="d-flex align-items-center my-3">
            ...
            <div className="col-6">
            <InputLabel htmlFor="outlined-basic">Promotion Date *</InputLabel>
