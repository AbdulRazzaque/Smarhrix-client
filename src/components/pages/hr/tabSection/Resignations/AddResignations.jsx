...
const BootstrapDialog = styled(Dialog)(({ theme }) => ({
 ...
 const AddResignations= ({open,handleClickOpen,handleClose})=> {
...
{/* ===================================================================================================================================================================== */}
        ...
        <p className="whitboxtitle ml-4 my-4">Add Resignations</p>
        ...
        <div className="d-flex align-items-center my-3">
            ...
            <div className="col-6">
            <InputLabel htmlFor="outlined-basic">Notic Date *</InputLabel>
        ...
        <div className="d-flex align-items-center my-3">
            ...
            <div className="col-6">
            <InputLabel htmlFor="outlined-basic">Resignation Date</InputLabel>
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                <DatePicker
                  // sx={{ width: 700 }}
