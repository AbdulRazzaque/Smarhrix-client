...
const BootstrapDialog = styled(Dialog)(({ theme }) => ({
 ...
 const AddComplaints = ({open,handleClickOpen,handleClose})=> {
...
{/* ===================================================================================================================================================================== */}
        ...
        <p className="whitboxtitle ml-4 my-4">Add Complaint</p>
        ...
        <div className="d-flex align-items-center my-3">
            ...
            <Autocomplete
              ...
              <div className="col-6">
              <InputLabel htmlFor="outlined-basic">Complaint From*</InputLabel>
              <TextField
                id="outlined-basic"
                sx={{ 
                width:'100%',   maxWidth: '500Px' 
        ...
        <div className="d-flex align-items-center my-3">
            ...
            <div className="col-6">
            <InputLabel htmlFor="outlined-basic">Complaint Against *</InputLabel>
              <TextField
                id="outlined-basic"
                sx={{ 
                width:'100%',   maxWidth: '500Px' 
            ...
            <div className="col-6">
            <InputLabel htmlFor="outlined-basic">Complaint Title *</InputLabel>
            <TextField
                id="outlined-basic"
                sx={{ 
                width:'100%',   maxWidth: '500Px' 
        ...
        <div className="d-flex align-items-center my-3">
            ...
            <div className="col-6">
            <InputLabel htmlFor="outlined-basic">Complaint Date</InputLabel>
