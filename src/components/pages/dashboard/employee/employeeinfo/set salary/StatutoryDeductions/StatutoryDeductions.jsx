...
const StatutoryDeductions = () => {
  ...
  const [update,setUpdate]=useState([])
    ...
    const columns = [
        ...
        { field: 'deduction_option', headerName: 'Deductions Type', width: 150 },
        { field: 'deduction_title', headerName: 'Title', width: 150 },
        { field: 'deduction_amount', headerName: 'Amount', width: 150 },
...
//=======================================================Delete code & api here ==============================================================
  const deleteRow = async (update) => {
    ...
    try {
      await axios
        .post(
          `${process.env.REACT_APP_DEVELOPMENT}/api/employees/set-salary/delete-statutory-deduction/${update.uuid}`,)
          .then(response=>{
  ...
  return (
    ...
    <div className="col-md-8  ml-3">
      ...
      <div className="d-flex justify-content-start">
        <div className="p-2 boxtitle">All Statutory Deductions</div>
