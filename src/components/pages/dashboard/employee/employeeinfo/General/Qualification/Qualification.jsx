...
const Qualification = () => {
  ...
  const handleClose = () => {
    ...
    const columns = [
        ...
        { field: 'MonthYear', headerName: 'School/University', width: 150 },
        { field: 'PayslipType', headerName: 'Time Period', width: 150 },
        { field: 'Email', headerName: 'Education Level', width: 150 },
